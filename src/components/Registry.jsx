...
const Registry = (props) => {
    return (
        <Block blockTitle="Registry" {...props} button buttonText="view registry" buttonLink="https://www.crateandbarrel.com/gift-registry/zach-hannum-and-bella-anderson/r6082663">
            <div>
                <h2>Crate & Barrel</h2>
